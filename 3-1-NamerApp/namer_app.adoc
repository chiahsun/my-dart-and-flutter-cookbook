...
[source,dart]
----
include::3-CreateAProject/main.dart[lines=20]
----
...
[source,yaml]
----
include::3-CreateAProject/pubspec.yaml[lines=30]
include::3-CreateAProject/pubspec.yaml[lines=38]
----

`lib/main.dart`
[source,dart]
----
include::3-CreateAProject/main.dart[lines=2]
include::3-CreateAProject/main.dart[lines=28..31]
...
----
include::3-CreateAProject/pubspec.yaml[lines=30]
include::3-CreateAProject/pubspec.yaml[lines=39]
----

`lib/main.dart`
[source,dart]
----
include::3-CreateAProject/main.dart[lines=10..27]
include::3-CreateAProject/main.dart[lines=33..37]
    ...
  }
}
----
...
[source,dart]
----
include::4-MakeAButton/main.dart[lines=6..8]
----
<1> Run the app named `MyApp` from `main`.

[source,dart]
----
include::4-MakeAButton/main.dart[lines=10..27]

include::4-MakeAButton/main.dart[lines=29..31]
----
...
[source,dart]
----
include::4-MakeAButton/main.dart[lines=33..50]
----
...
[source,dart]
----
include::4-MakeAButton/main2.dart[lines=29..36]
----
...
[source,dart]
----
include::4-MakeAButton/main2.dart[lines=48..50]
----
...
[source,dart]
----
include::4-MakeAButton/main2.dart[lines=46]
----
...
[source,dart]
----
include::5-ExtractWidget/BigCard.dart[lines=2..14]
----
...
[source,dart]
----
include::5-ExtractWidget/BigCard2.dart[lines=11..16]
----
...
[source,dart]
----
include::5-ExtractWidget/BigCard3.dart[lines=11..18]
----
<1> Wrap with card
...
[source,dart]
----
include::5-ExtractWidget/BigCard4.dart[lines=11..21]
----
<1> Get context
...
[source,dart]
----
include::5-ExtractWidget/BigCard5.dart[lines=11..24]
----
...
[source,dart]
----
include::5-ExtractWidget/MyHomePage.dart[lines=2..21]
----
...
[source,dart]
----
include::5-ExtractWidget/MyHomePage2.dart[lines=2..22]
----
...
[source,dart]
----
include::6-AddFavoriteButton/main.dart[lines=29..47]
----

[source,dart]
----
include::6-AddFavoriteButton/main.dart[lines=62..84]
----
...
[source,dart]
----
include::7-AddNavigationRail/main.dart[lines=49..75]
----
...
[source,dart]
----
include::7-AddNavigationRail/main.dart[lines=77..114]
----
...
[source,dart]
----
include::7-AddNavigationRail/main2.dart[lines=49..52]
----
...
[source,dart]
----
include::7-AddNavigationRail/main2.dart[lines=54..84]
----
...
[source,dart]
----
include::7-AddNavigationRail/main3.dart[lines=59..69]
----
...
[source,dart]
----
include::7-AddNavigationRail/main3.dart[lines=88..92]
----
...
[source,dart]
----
include::7-AddNavigationRail/main4.dart[lines=71..78]
    ...
----
...
[source,dart]
----
include::8-AddFavoritesPage/main.dart[lines=166..189]
----
