...
void main() {
  group('TimerBloc', () {
    ...
    blocTest( 'emits 5 TimerRunning 5 times followed by TimerComplete when timer is started for real ticker.',
      build: () => TimerBloc(ticker: ticker),
      act: (bloc) async { bloc.add(const StartTimer(duration: testTicks)); },
